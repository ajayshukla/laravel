...
<div class="page-content">
    ...
    <div class="col-lg-12 col-xs-12 col-sm-12">
        ...
        <div class="portlet light">
            ...
            <?php echo e(Form::model($definition, array('route' => array('shareddefinition.update', $definition->id), 'method' => 'PUT','name' => 'shareddefinition'))); ?>

             <div class="form-group">
                    <?php echo e(Form::label('tenures', 'Installment Tenures')); ?>

                    <div>
                        <?php echo e(Form::text('tenures',$definition->installmenttenures, array('class' => 'form-control'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <?php echo e(Form::text('cardtype',$definition->name, array('class' => 'form-control'))); ?>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <?php echo e(Form::text('cardidentifiers',$definition->cardidentifiers, array('class' => 'form-control'))); ?>
