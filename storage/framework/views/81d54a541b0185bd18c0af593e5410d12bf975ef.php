    ...
    <div class="col-lg-12 col-xs-12 col-sm-12">
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption"> Create Promo Offer</div>
            </div>
            ...
            <?php echo e(Form::open(array('url' => 'promooffer','name' => 'promooffer'))); ?>
            ...
            <?php echo e(Form::hidden('url',URL::to('/'),array('id' => 'url'))); ?>
                ...
                <div class="form-group abc">
                    ...
                    <div class="interest">
                   	<?php $__currentLoopData = $definition_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $definition_list): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    	<?php echo e(Form::text('interestrate[]',$definition_list->installmenttenures, array('class' => 'form-control interestrate'))); ?>
                ...
                <div class="form-group">
                <div><b>Equal Monthly installment</b>&nbsp;&nbsp;&nbsp;<span id="monthlyinstallment" style="text-align:center"></span></div></br>
                <div>Amount Financed (Rs.):&nbsp;&nbsp;&nbsp;<span id="financed" style="text-align:center"></span></div></br>
                <div>Interest Paid (Rs.):&nbsp;&nbsp;&nbsp;<span id="paid" style="text-align:center"></span></div></br>
                <div>Administration Fee (Rs.):&nbsp;&nbsp;&nbsp;<span id="administratorfees" style="text-align:center"></span></div></br>
                <div>Total Cost (Rs.):&nbsp;&nbsp;&nbsp;<span id="totalcost" style="text-align:center"></span></div>
                </div>
