                                    ...
                                    <div class="table-container">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                                            <thead>
                                                ...
                                                @foreach($standardoffers as $standardoffersRes)
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>{{ $standardoffersRes->id }}</td>
                                                    <td>{{ $standardoffersRes->offertitle }}</td>
                                                    <td>{{ $standardoffersRes->offerref }}</td>
                                                    <td>{{ $standardoffersRes->effectivedate }}</td>
                                                    <td>{{ $standardoffersRes->effectivetime }}</td>
                                                    @if(Auth::user()->id==1)
                                                    <td> {{ $standardoffersRes->role->name }} </td>
                                                    @endif
                                                    <td>
                                                        {{ $standardoffersRes->status }}
                                                    </td>
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            <a href="{{ route('standardoffer.edit', $standardoffersRes->id) }}"><button class="btn btn-sm btn-success filter-submit margin-bottom">Edit</button></a>
                                                        {!! Form::open(['method' => 'DELETE','route' => ['standardoffer.destroy', $standardoffersRes->id]]) !!}
        												...
        												{!! Form::close() !!}   
                                                        <a href="{{ URL::to('standardoffer/' . $standardoffersRes->id) }}"><button class="btn btn-sm btn-success filter-submit margin-bottom">View</button></a> 
                                                        </div>
