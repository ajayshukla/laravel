...
<div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <li class="nav-item start open">
                            <a href="{{ url('/admin') }}" class="nav-link nav-toggle" aria-expanded="true"><i class="icon-home menuicon fa"></i>Dashboard</a>
                      </li>
                      
                      <li class="nav-item start open" id="offer">
                            <a href="{{ url('/offers') }}" class="nav-link nav-toggle"><i class="fa fa-gift menuicon"></i>Offers</a>
                                <ul @if(Request::segment(1) == 'standardoffer' || Request::segment(1) == 'promooffer' || Request::segment(1) == 'offers') style="display:block" @endif class="page-sidebar-menu suboffer" style="display:none">
                                    <!--<li class="nav-item start open standardoffer">
                                        <a href="{{ url('/offers') }}" class="nav-link nav-toggle"><i class="fa fa-gift menuicon"></i>All Offers</a>
                                    </li>-->
                                    <li class="nav-item start open standardoffer">
                                        <a href="{{ url('/standardoffer') }}" class="nav-link nav-toggle"><i class="fa fa-gift menuicon"></i>Standard Offer</a>
                                    </li>
                                    <li class="nav-item start open promooffer">
                                        <a href="{{ url('/promooffer') }}" class="nav-link nav-toggle"><i class="fa fa-gift menuicon"></i>Promo Offer</a>
                                    </li>
                            </ul> 
                      </li>
                    <!--<li class="nav-item start open standardoffer">
                    ...
                    <li class="nav-item start open promooffer">
                        <a href="{{ url('/promooffer') }}" class="nav-link nav-toggle"><i class="fa fa-gift menuicon"></i>Promo Offer</a>
                   	  ...
                   	  <li class="nav-item start open">
                            <a href="{{ url('/report') }}" class="nav-link nav-toggle"><i class="fa fa-flag menuicon"></i>Report</a>
                      </li>
                      <li class="nav-item start open" id="definition">
                            <a href="javascript:void(0)" class="nav-link nav-toggle"><i class="fa fa-flag menuicon"></i>Shared Definitions</a>
                                <ul @if(Request::segment(1) == 'tenures' || Request::segment(1) == 'shareddefinition') style="display:block" @endif class="page-sidebar-menu subdefinition" style="display:none">
                                    <!--<li class="nav-item start open standardoffer">
                                        <a href="{{ url('/offers') }}" class="nav-link nav-toggle"><i class="fa fa-gift menuicon"></i>All Offers</a>
                                    </li>-->
                                    <li class="nav-item start open standardoffer">
                                        <a href="{{ url('/tenures') }}" class="nav-link nav-toggle"><i class="fa fa-flag menuicon"></i>Tenures</a>
                                    </li>
                                    <li class="nav-item start open promooffer">
                                        <a href="{{ url('/shareddefinition') }}" class="nav-link nav-toggle"><i class="fa fa-flag menuicon"></i>Card Types</a>
                                    </li>
                            </ul>
                      </li>
                      <li class="nav-item start open">
                            <a href="{{ url('/user') }}" class="nav-link nav-toggle"><i class="fa fa-users menuicon"></i>User Management</a>
                      </li>
