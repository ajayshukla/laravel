                                ...
                                <div class="mt-comments">
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="{{ url('images/avatar1.jpg') }}" /> </div>
                                    ...
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="{{ url('images/avatar6.jpg') }}" /> </div>
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                    ...
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="{{ url('images/avatar8.jpg') }}" /> </div>
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                    ...
                                    <div class="mt-comment">
                                        <div class="mt-comment-img">
                                            <img src="{{ url('images/avatar4.jpg') }}" /> </div>
                                        <div class="mt-comment-body">
                                            <div class="mt-comment-info">
                                ...
                                <div class="mt-actions">
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="{{ url('images/avatar10.jpg') }}" /> </div>
                                    ...
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="{{ url('images/avatar3.jpg') }}" /> </div>
                                        <div class="mt-action-body">
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    <div class="mt-action-icon ">
                                    ...
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="{{ url('images/avatar2.jpg') }}" /> </div>
                                        <div class="mt-action-body">
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    <div class="mt-action-icon ">
                                    ...
                                    <div class="mt-action">
                                        <div class="mt-action-img">
                                            <img src="{{ url('images/avatar7.jpg') }}" /> </div>
                                        <div class="mt-action-body">
                                            <div class="mt-action-row">
                                                <div class="mt-action-info ">
                                                    <div class="mt-action-icon ">
                            ...
                            <div class="events-content">
                                <ol>
                                    <li class="selected" data-date="16/01/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar4.jpg') }}" />
                                            </div>
                                    ...
                                    <li data-date="28/02/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar1.jpg') }}" />
                                            </div>
                                            <div class="mt-author-name">
                                    ...
                                    <li data-date="20/04/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar6.jpg') }}" />
                                            </div>
                                            <div class="mt-author-name">
                                    ...
                                    <li data-date="20/05/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar8.jpg') }}" />
                                            </div>
                                            <div class="mt-author-name">
                                                <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                            </div>
                                    ...
                                    <li data-date="09/07/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar2.jpg') }}" />
                                            </div>
                                            <div class="mt-author-name">
                                    ...
                                    <li data-date="15/09/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar3.jpg') }}avatar80_5.jpg" />
                                            </div>
                                            <div class="mt-author-name">
                                    ...
                                    <li data-date="01/11/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar3.jpg') }}avatar80_2.jpg" />
                                            </div>
                                            <div class="mt-author-name">
                                                <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                            </div>
                            ...
                            <div class="events-content">
                                <ol>
                                    ...
                                    <li data-date="28/02/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar3.jpg') }}avatar80_3.jpg" />
                                            </div>
                                            <div class="mt-author-name">
                                                <a href="javascript:;" class="font-blue-madison">Hugh Grant</a>
                                            </div>
                                    ...
                                    <li data-date="20/04/2014">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar3.jpg') }}avatar80_1.jpg" />
                                            </div>
                                            <div class="mt-author-name">
                                                <a href="javascript:;" class="font-blue">Rory Matthew</a>
                                            </div>
                                    ...
                                    <li data-date="03/03/2015">
                                        ...
                                        <div class="mt-author">
                                            <div class="mt-avatar">
                                                <img src="{{ url('images/avatar3.jpg') }}" />
                                            </div>
                                            <div class="mt-author-name">
                                                <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                                            </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable table-scrollable-borderless">
                            <table class="table table-hover table-light">
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic rounded" src="{{ url('images/avatar3.jpg') }}"> </td>
                                    <td>
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ url('images/avatar3.jpg') }}">
                ...
                <!--<div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <div id="region_statistics_loading">
                            <img src="{{ url('images/avatar3.jpg') }}" alt="loading" /> </div>
