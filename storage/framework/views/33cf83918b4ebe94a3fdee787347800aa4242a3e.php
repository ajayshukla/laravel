    ...
    <div class="col-lg-12 col-xs-12 col-sm-12">
                ...
                <?php endif; ?>
                                <div class="portlet-title">
                                    <div class="caption">
                                        <?php echo e($Title); ?> Offer Listing </div>
                                    <div class="actions">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_products">
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td><?php echo e($standardoffers->id); ?></td>
                                                    <td><?php echo e($standardoffers->offertitle); ?></td>
                                                    <td><?php echo e($standardoffers->offerref); ?></td>
                                                    <td><?php echo e($standardoffers->effectivedate); ?></td>
                                                    <td><?php echo e($standardoffers->effectivetime); ?></td>
                                                    <?php if(Auth::user()->id==1): ?>
                                                    <td> <?php echo e($standardoffers->name); ?> </td>
                                                    <?php endif; ?>
                                                    <td>
                                                        <?php echo e($standardoffers->status); ?>

                                                    </td>
                                                    <td>
                                                        <div class="margin-bottom-5">
                                                            <a href="<?php echo e(route('standardoffer.edit', $standardoffers->id)); ?>"><button class="btn btn-sm btn-success filter-submit margin-bottom">Edit</button></a>
                                                        <?php echo Form::open(['method' => 'DELETE','route' => ['standardoffer.destroy', $standardoffers->id]]); ?>
        												...
        												<?php echo Form::close(); ?>   
                                                        <a href="<?php echo e(URL::to('standardoffer/' . $standardoffers->id)); ?>"><button class="btn btn-sm btn-success filter-submit margin-bottom">View</button></a> 
                                                        </div>
